...
public class Player_Position_Script : MonoBehaviour
{
    //public bool showgui;
    ...
    public Enemy_Car_Position_Script[] computercars;
    ...
    public virtual void Update()
    {
        ...
        this.raceposition = 0;
        foreach (Enemy_Car_Position_Script scripts in this.computercars)
        {
        ...
        else
        {
            ...
            pos.text = this.raceposition.ToString();
    ...
    public Player_Position_Script()
    {
        //this.showgui = true;
        this.textureEnabled = true;
        this.positionTextures = new Material[this.ElementsSize];
        //this.PosTextures = new Texture[this.ElementsSize];
        playerpos = this.raceposition;
        //pos.text = this.positionn.ToString();
        this.ElementsExpand = true;
        this.ElementsSize = 1;
        this.computercars = new Enemy_Car_Position_Script[this.computercars_ElementsSize];
