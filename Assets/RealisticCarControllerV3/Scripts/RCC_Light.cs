...
public class RCC_Light : MonoBehaviour {
	...
	// For Indicators.
	private Death_Race_CarControllerV3.IndicatorsOn indicatorsOn;
	private AudioSource indicatorSound;
	public AudioClip indicatorClip{get{return RCCSettings.indicatorClip;}}

	void Start () {
		
		carController = GetComponentInParent<Death_Race_CarControllerV3>();
	...
	void Indicators(){
		...
		case Death_Race_CarControllerV3.IndicatorsOn.Left:
		...
		case Death_Race_CarControllerV3.IndicatorsOn.Right:
		...
		case Death_Race_CarControllerV3.IndicatorsOn.All:
		...
		case Death_Race_CarControllerV3.IndicatorsOn.Off:
